...
from FRAbounds import FRAbounds



os.chdir('D:/Data/F1815_Cruella/weekfebruary282022/F1815_Cruella')
...
os.chdir('D:/Electrophysiological Data/F1815_Cruella/HP_Block1-10')
spikes_data = sio.loadmat('spikesBlock1-10BB2andBB3April-16-2022- 4-20-44-566-PM.mat')
...
f32file = 0
bounds, bf, Th, data, spikes = FRAbounds(avgspikes, freqs, lvls, f32file)
